<form action='<? echo $_SERVER['PHP_SELF']; ?>' method='POST' name='account_update_form' id='account_update_form'>
	...
	<fieldset>
	<p>
		<input type='hidden' value='<?php echo $rental_customers_id; ?>' name='rental_customers_id' id='form_submitted' />
