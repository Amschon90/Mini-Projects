...
$select_reservations = "select CONCAT (first_name,' ', last_name) as 'Drivers Name', reservation_date, location, style, description, (daily_rate * rental_days) as 'Subtotal'
...
if(!$exec_select_reservations){
	...
	echo "<tr><td colspan='5'>Number of Reservations:</td><td>".mysqli_num_rows($exec_select_reservations)."</td></tr></table>";
