<form action='<? echo $_SERVER['PHP_SELF']; ?>' method='POST' name='car_rental_form' id='car_rental_form'>
	<fieldset><legend>Your Name and Password</legend>
		<?php
			...
			create_form_field('Phone:', 'tel', 'phone', 'phone', ['maxlength'=>'20', 'size'=>'20', 'tabindex'=>'4', 'title'=>'Type in Your Phone Number', 'required'=>'required', 'placeholder'=>'(XXX)-XXX-XXXX'], $errors_array);
			...
			create_form_field('Address 2:', 'text', 'address_2', 'address_2', ['maxlength'=>'100', 'size'=>'50', 'tabindex'=>'7', 'title'=>'Home Address', 'required'=>'required', 'pattern'=>'[A-Za-z0-9_\.\#\' \-:=]{0,100}', 'placeholder'=>'Suite #9'], $errors_array);
			create_form_field('City:', 'text', 'city', 'city', ['maxlength'=>'50', 'size'=>'20', 'tabindex'=>'8', 'title'=>'City', 'required'=>'required', 'pattern'=>'[A-Za-z]{2,50}', 'placeholder'=>'Youngstown'], $errors_array);
			create_form_field('Zip:', 'text', 'zip', 'zip', ['maxlength'=>'5', 'size'=>'5', 'tabindex'=>'10', 'title'=>'Zip Code', 'required'=>'required', 'placeholder'=>'44555'], $errors_array);
		?>
	</fieldset>
